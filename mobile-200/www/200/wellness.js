...
async function deleteSelectedExercise(){
  ...
  catch(error){ elements.detailEquipment.textContent=error instanceof Error?error.message:"Não foi possível excluir o exercício."; }
