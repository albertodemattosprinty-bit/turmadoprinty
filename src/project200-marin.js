...
Cada minuto de ação concluída vale um ponto. Os pontos abastecem os aspectos gerais; Finanças, Nutrição e Exercícios evoluem pelos próprios universos nativos. Os 12 aspectos são: Sono, Alimentação, Hidratação, Aprendizado, Trabalho, Casa, Exercícios, Social, Finanças, Higiene, Lazer e Família. O objetivo é construir, ao longo dos anos, um Plano de Vida saudável, próspero, sustentável e personalizado, com horizonte de cinco anos.
