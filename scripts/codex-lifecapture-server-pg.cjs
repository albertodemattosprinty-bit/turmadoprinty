...
insertBefore('async function handleProject200LifeCaptureUploadRequest(request, response) {', `async function ensureProject200LifeCapturesSchema() {
  await query(\`
